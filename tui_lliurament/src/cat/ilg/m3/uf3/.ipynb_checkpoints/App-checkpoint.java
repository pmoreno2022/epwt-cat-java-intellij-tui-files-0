...
public class App {
    ...
    static public Student[] initTui() {
        ...
        System.out.println("Number of students is: " + number);

        int numberOfStudents = stringToInt(number);
        ...
        if(numberOfStudents > 0) {
            ...
            for(int i = 0; i < numberOfStudents; i++){
                ...
                newStudent.name = scanin.nextLine();

                System.out.print("Enter age: ");
                newStudent.age = stringToInt(scanin.nextLine());

                System.out.print("Enter amount of enrolled subjects: ");
                newStudent.amountOfEnrolledSubjects = stringToInt(scanin.nextLine());
